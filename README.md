...
A Chrome extension that translates selected text on any webpage using OpenAI's GPT models. It provides context-aware translations and beginner-friendly explanations.
...
2.  Right-click and choose "Translate with AI".
3.  A popup will appear with the translation and explanation.
